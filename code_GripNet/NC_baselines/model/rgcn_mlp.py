...
parser.add_argument('--in_dim', type=int, default=32, help='dimensions for input one-hot conversion')
...
class Net(torch.nn.Module):
    def __init__(self):
        ...
        self.conv2 = RGCNConv(hidden_size, embedding, data.num_relations, num_bases=data.num_relations)
